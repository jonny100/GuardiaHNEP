...
@FacesConverter(value = "medicamentosConverter")
public class MedicamentosConverter implements Converter {

    @Inject
    private MedicamentosFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Medicamentos) {
            ...
            return getStringKey(o.getCodIdMedicamento());
        } else {
